  ...
  <div class="max-w-md w-full space-y-8">
    <div>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 202.97 197.7" class="mx-auto h-16 w-16 fill-current text-blue-900">
        <path d="M170,94.52l-35.9-20.73-24.34,14,11.62,6.71a5,5,0,0,1,0,8.66L32.5,154.52a5,5,0,0,1-7.5-4.33 V99.61a6.44,6.44,0,0,1,0-1.52V47.51a5,5,0,0,1,7.5-4.33l35,20.23,24.32-14L7.5.68A5,5,0,0,0 ,0,5V192.69A5,5,0,0,0,7.5,197L170,103.18A5,5,0,0,0,170,94.52Z"/>
      ...
      <h2 class="mt-6 text-center text-3xl font-extravold text-gray-900">
        {{config('app.name')}}
      </h2>
      <p class="mt-2 text-center text-sm text-gray-600">
                <span class="font-medium text-blue-600 hover:text-blue-900">
                    For the first time, please register an administrative account
                </span>
      </p>
    </div>

...
class Menu
{
    ...
    public function getAll(string $layout): array
    {
        ...
        return \Hairavel\Core\Facades\Menu::getData();
    }
    ...
    {
        $apps = \Hairavel\Core\Facades\Menu::getApps();

...
class Link implements Component
{
     ...
     */
    public function add(string $name, string $route, array $params = [], bool $absolute = false): \Hairavel\Core\UI\Widget\Link
    {
        $link = new \Hairavel\Core\UI\Widget\Link($name, $route, $params, $absolute);

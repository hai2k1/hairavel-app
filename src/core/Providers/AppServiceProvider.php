...
use Hairavel\Core\Util\MenuStore;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        \Route::macro('manage', function ($class, $name = '') {
            return (new \Hairavel\Core\Util\Route($class, $name));
        });
    ...
    public function boot()
    {
        ...
        // 注册模板组件
        Blade::component('app-loading', \Hairavel\Core\UI\Components\Loading::class);
        Blade::component('app-nodata', \Hairavel\Core\UI\Components\NoData::class);
        Blade::component('app-trend', \Hairavel\Core\UI\Components\Trend::class);
